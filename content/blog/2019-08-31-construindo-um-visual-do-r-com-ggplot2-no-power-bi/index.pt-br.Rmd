...
<center>
![](/blog/2019-08-31-construindo-um-visual-do-r-com-ggplot2-no-power-bi/index.pt-br_files/1567281358972.png){width=80% height=80%}</center>
...
<center>
![](/blog/2019-08-31-construindo-um-visual-do-r-com-ggplot2-no-power-bi/index.pt-br_files/1567281665885.png){width=60% height=60%}

![](/blog/2019-08-31-construindo-um-visual-do-r-com-ggplot2-no-power-bi/index.pt-br_files/1567281703452.png){width=70% height=70%}
</center>
...
<center>
![](/blog/2019-08-31-construindo-um-visual-do-r-com-ggplot2-no-power-bi/index.pt-br_files/1567281775880.png){width=90% height=90%} </center>
...
![](/blog/2019-08-31-construindo-um-visual-do-r-com-ggplot2-no-power-bi/index.pt-br_files/1567282291313.png){width=100% height=100%}

Substitua o caracter `.` por `,`, conforme a imagem abaixo:

<center>
![](/blog/2019-08-31-construindo-um-visual-do-r-com-ggplot2-no-power-bi/index.pt-br_files/1567282400722.png){width=80% height=80%}</center>
...
<center>
![](/blog/2019-08-31-construindo-um-visual-do-r-com-ggplot2-no-power-bi/index.pt-br_files/1567282441523.png){width=50% height=50%}</center>
...
<center>
![](/blog/2019-08-31-construindo-um-visual-do-r-com-ggplot2-no-power-bi/index.pt-br_files/1567282533067.png){width=50% height=50%}</center>
...
<center>
![](/blog/2019-08-31-construindo-um-visual-do-r-com-ggplot2-no-power-bi/index.pt-br_files/1567288638360.png){width=50% height=50%}</center>
...
<center>
![](/blog/2019-08-31-construindo-um-visual-do-r-com-ggplot2-no-power-bi/index.pt-br_files/1567282686352.png){width=50% height=50%}</center>
...
<center>
![](/blog/2019-08-31-construindo-um-visual-do-r-com-ggplot2-no-power-bi/index.pt-br_files/1567283556059.png){width=50% height=50%}

![](/blog/2019-08-31-construindo-um-visual-do-r-com-ggplot2-no-power-bi/index.pt-br_files/1567283624314.png){width=50% height=50%}
</center>
...
![](/blog/2019-08-31-construindo-um-visual-do-r-com-ggplot2-no-power-bi/index.pt-br_files/1567283726139.png){width=100% height=100%}
...
<center>
![](/blog/2019-08-31-construindo-um-visual-do-r-com-ggplot2-no-power-bi/index.pt-br_files/1567284316132.png){width=50% height=50%}
</center>
...
![](/blog/2019-08-31-construindo-um-visual-do-r-com-ggplot2-no-power-bi/index.pt-br_files/1567284155312.png){width=100% height=100%}
...
<center>
![](/blog/2019-08-31-construindo-um-visual-do-r-com-ggplot2-no-power-bi/index.pt-br_files/1567284388822.png){width=50% height=50%} </center>
...
<center>
![](/blog/2019-08-31-construindo-um-visual-do-r-com-ggplot2-no-power-bi/index.pt-br_files/1567284609387.png){width=80% height=80%} </center>
...
<center>
![](/blog/2019-08-31-construindo-um-visual-do-r-com-ggplot2-no-power-bi/index.pt-br_files/1567284843577.png){width=80% height=80%}</center>
...
<center>
![](/blog/2019-08-31-construindo-um-visual-do-r-com-ggplot2-no-power-bi/index.pt-br_files/1567284898567.png){width=80% height=80%}</center>
...
<center>
![](/blog/2019-08-31-construindo-um-visual-do-r-com-ggplot2-no-power-bi/index.pt-br_files/1567284967315.png){width=80% height=80%}</center>
...
![](/blog/2019-08-31-construindo-um-visual-do-r-com-ggplot2-no-power-bi/index.pt-br_files/1567285078877.png){width=100% height=100%}
...
![](/blog/2019-08-31-construindo-um-visual-do-r-com-ggplot2-no-power-bi/index.pt-br_files/1567285219581.png){width=100% height=100%}
...
![](/blog/2019-08-31-construindo-um-visual-do-r-com-ggplot2-no-power-bi/index.pt-br_files/1567285295211.png){width=100% height=100%}
...
![](/blog/2019-08-31-construindo-um-visual-do-r-com-ggplot2-no-power-bi/index.pt-br_files/1567285360188.png){width=100% height=100%}
...
![](/blog/2019-08-31-construindo-um-visual-do-r-com-ggplot2-no-power-bi/index.pt-br_files/1567285564230.png){width=100% height=100%}
...
![](/blog/2019-08-31-construindo-um-visual-do-r-com-ggplot2-no-power-bi/index.pt-br_files/1567285589371.png){width=100% height=100%}
...
![](/blog/2019-08-31-construindo-um-visual-do-r-com-ggplot2-no-power-bi/index.pt-br_files/1567285701501.png){width=100% height=100%}

No canto direto da barra escura do editor, clique em executar.

![](/blog/2019-08-31-construindo-um-visual-do-r-com-ggplot2-no-power-bi/index.pt-br_files/1567285747832.png){width=100% height=100%}

Redimensione o objeto para o tamanho desejado e clique em executar novamente para renderizar a alteração.

![](/blog/2019-08-31-construindo-um-visual-do-r-com-ggplot2-no-power-bi/index.pt-br_files/1567285789446.png){width=100% height=100%}

Se desejar, na aba format do menu do gráfico, é possível customizar o título do gráfico.

![](/blog/2019-08-31-construindo-um-visual-do-r-com-ggplot2-no-power-bi/index.pt-br_files/1567290320330.png){width=100% height=100%}
...
<center>
![](/blog/2019-08-31-construindo-um-visual-do-r-com-ggplot2-no-power-bi/index.pt-br_files/1567285877699.png){width=80% height=80%}</center>
...
<center>
![](/blog/2019-08-31-construindo-um-visual-do-r-com-ggplot2-no-power-bi/index.pt-br_files/1567285857855.png){width=80% height=80%}</center>

Agora o painel de filtros estará disponível para incluirmos os campos desejados.

<center>
![](/blog/2019-08-31-construindo-um-visual-do-r-com-ggplot2-no-power-bi/index.pt-br_files/1567285934915.png){width=80% height=80%}</center>
...
![](/blog/2019-08-31-construindo-um-visual-do-r-com-ggplot2-no-power-bi/index.pt-br_files/1567286032676.png){width=100% height=100%}
