...
date: '2019-05-09'
slug: []
banner: img/banners/pbi_sheets.jpg
categories:
  - tutoriais
tags:
  - power bi
...
<center>
![](/blog/2019-05-09-power-bi-obtendo-dados-do-google-sheets/index.pt-br_files/1557435655415.png){width=50% height=50%}</center>
...
<center>
![](/blog/2019-05-09-power-bi-obtendo-dados-do-google-sheets/index.pt-br_files/1557435698985.png){width=50% height=50%}</center>
...
![](/blog/2019-05-09-power-bi-obtendo-dados-do-google-sheets/index.pt-br_files/1557436069627.png){width=100% height=100%}

E, no modo de edição, apenas removi as linhas em branco e alterei o nome da tabela para *Iris*.

<center>
![](/blog/2019-05-09-power-bi-obtendo-dados-do-google-sheets/index.pt-br_files/1557436188931.png){width=50% height=50%} </center>

Após fechar e aplicar, tudo pronto para criar os relatórios dinâmicos.

![](/blog/2019-05-09-power-bi-obtendo-dados-do-google-sheets/index.pt-br_files/1557436500817.png){width=100% height=100%}
